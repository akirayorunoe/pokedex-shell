...
const {queryOptions} = await importShared('@tanstack/react-query');

function fetchPokemonsQueryOptions() {
    return queryOptions({
        queryKey: ['pokemons'],
...
function useVirtualizerBase(options) {
  ...
  const [instance] = React$1.useState(
...
function Card({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `bg-[red]`, style: { height: "50px" }, onClick: () => navigate(`/detail/${getPokeId(data?.url)}`), children: data?.name });
}
...
const {useSuspenseInfiniteQuery} = await importShared('@tanstack/react-query');
...
const PokeList = () => {
  const { data, error, fetchNextPage, isFetchingNextPage, hasNextPage } = useSuspenseInfiniteQuery({
    ...
    getNextPageParam: (lastPage) => {
      ...
      const nextOffset = Number(queryParams?.offset);
      return isNaN(nextOffset) ? void 0 : nextOffset;
    }
  });
  ...
  if (error) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Error" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollRef, className: "w-[90dvw] h-[90dvh] overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", style: { height: `${virtualizer.getTotalSize()}px` }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
        ...
        virtualItems.map((vItem) => {
          if (vItem.index >= pokemonsData.length) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, style: {
              ...
              padding: 20,
              color: "gray"
            }, children: isFetchingNextPage && "Loading more..." }, vItem.key);
          }
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { data: pokemon })
            },
            vItem.key
          );
        }),
        !hasNextPage && !isFetchingNextPage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          fontSize: 20
        }, children: "No more Pokémon" })
      ]
    }
  ) }) });
};

export { PokeList as default };
